...
public static class AnimatorParams
{
    ...
    public static readonly int TurnInPlaceDeg = Animator.StringToHash("TurnInPlaceDeg");
    ...
    public static readonly int TriggerDismount = Animator.StringToHash("Dismount");
    public static readonly int TriggerClimbUp = Animator.StringToHash("ClimbUp");
